...
<div class="wrap">
    ...
    <p><?php _e('Administrator를 제외한 모든 역할의 사용자에게 적용되는 관리자 바 숨김, 메뉴 스타일링, 관리자 바 제목 설정을 관리할 수 있습니다.', 'dasom-church'); ?></p>
    ...
    <form method="post" action="">
        ...
        <table class="form-table">
            <tr>
                ...
                <td>
                    ...
                    <p class="description"><?php _e('기본적으로 Administrator를 제외한 모든 역할의 사용자에게 관리자 바가 숨겨집니다. 체크 해제하면 프론트엔드와 백엔드(관리자 영역) 모두에서 관리자 바가 표시됩니다.', 'dasom-church'); ?></p>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <p class="description"><?php _e('Administrator를 제외한 모든 역할의 사용자에게 적용되는 관리자 메뉴의 배경색을 설정합니다.', 'dasom-church'); ?></p>
                </td>
            </tr>
            ...
            <tr>
                <th scope="row"><?php _e('관리자 메뉴 폰트 굵기', 'dasom-church'); ?></th>
                <td>
                    ...
                    <p class="description"><?php _e('관리자 메뉴의 폰트 굵기를 설정합니다.', 'dasom-church'); ?></p>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <p class="description"><?php _e('관리자 메뉴 상단에 표시될 제목을 설정합니다. HTML 태그 사용 가능: <br>, <strong>, <em>, <span style="color: red;"> 등. 비워두면 표시되지 않습니다.', 'dasom-church'); ?></p>
                </td>
            </tr>
        ...
        <div style="background:#f0f7ff;padding:15px;border-left:4px solid #2271b1;margin:20px 0;">
            <h3 style="margin-top:0;">💡 <?php _e('사용 방법:', 'dasom-church'); ?></h3>
            <ul style="margin-bottom:0;">
                    <li><?php _e('관리자 바 숨김: Administrator를 제외한 모든 역할의 사용자에게 적용됩니다. 기본적으로 관리자 바는 숨겨지며, 필요시 프론트엔드와 백엔드(관리자 영역) 모두에서 관리자 바를 표시할 수 있습니다.', 'dasom-church'); ?></li>
                    <li><?php _e('메뉴 스타일링: Administrator를 제외한 모든 역할의 사용자에게 적용되는 관리자 메뉴의 배경색과 폰트색을 커스터마이징할 수 있습니다.', 'dasom-church'); ?></li>
                    <li><?php _e('관리자 바 제목: Administrator를 제외한 모든 역할의 사용자에게 적용되는 관리자 바 상단에 표시될 브랜드명을 설정할 수 있습니다.', 'dasom-church'); ?></li>
                    <li><?php _e('Collapse Menu 숨김: Administrator를 제외한 모든 역할의 사용자에게 적용되는 Collapse Menu 버튼을 숨깁니다.', 'dasom-church'); ?></li>
            </ul>
        </div>
            ...
            <td>
                <fieldset>
                    ...
                    <p class="description" style="margin-top:8px;">
                        <?php echo esc_html__('활성화하면 DW 교회관리 메뉴에 "ACF 주보 마이그레이션", "ACF 설교 마이그레이션"이 나타나며, Post의 ACF 필드(주보: Sunday, Jubo File Url 등 / 설교: 일자, 설교자, 성경구절, YouTube)를 교회주보·설교로 옮길 수 있습니다.', 'dasom-church'); ?>
                    </p>
                </fieldset>
            </td>
        </tr>
