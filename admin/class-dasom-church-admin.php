...
class Dasom_Church_Admin {
    ...
    public function dasom_church_admin_menu() {
        ...
        // Add main menu items for Author/Editor roles
        $current_user = wp_get_current_user();
        if (in_array('author', $current_user->roles) || in_array('editor', $current_user->roles)) {
            // Add each submenu as main menu for Author/Editor
            ...
            if ($this->can_access_submenu('bulletin')) {
                add_menu_page(
                    ...
                    'edit_posts',
                    'dasom-church-bulletin',
                    array($this, 'redirect_to_bulletin'),
