...
class Test_Meta_Boxes extends WP_UnitTestCase {
    ...
    public function test_event_meta_save() {
        ...
        // Save meta
        update_post_meta($post_id, 'dw_event_department', 'ì²?…„ë¶€');
        update_post_meta($post_id, 'dw_event_datetime', '2025??10??20???¤í›„ 3??);
        ...
        $this->assertEquals('ì²?…„ë¶€', $department);
        $this->assertEquals('2025??10??20???¤í›„ 3??, $datetime);
