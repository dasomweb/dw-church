...
<body>
    ...
    <table>
        ...
        <tr>
            <td>🖥️ PC <code>(dw_banner_text_width_pc)</code></td>
            <td><strong class="success"><?php 
    ...
    <h2>🖼️ Background Image Position (Responsive)</h2>
    <table>
        <tr>
            <th>Device</th>
            <th>Position</th>
        ...
        <tr>
            <td>🖥️ PC <code>(dw_banner_bg_position_pc)</code></td>
            <td><strong class="success"><?php 
    ...
    <table>
        ...
        <tr>
            <td>⬆️ Top <code>(dw_banner_content_padding_top)</code></td>
            <td><strong class="success"><?php 
        ...
        <tr>
            <td>➡️ Right <code>(dw_banner_content_padding_right)</code></td>
            <td><strong class="success"><?php 
        ...
        <tr>
            <td>⬇️ Bottom <code>(dw_banner_content_padding_bottom)</code></td>
            <td><strong class="success"><?php 
        ...
        <tr>
            <td>⬅️ Left <code>(dw_banner_content_padding_left)</code></td>
            <td><strong class="success"><?php 
