...
class DW_Elementor_Recent_Gallery_Widget extends \Elementor\Widget_Base {
    ...
    public function get_keywords() {
        return ['gallery', 'album', 'church', 'photo', 'dw', 'Í∞§Îü¨Î¶?, '?®Î≤î'];
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'image_ratio',
            [
                'label' => __('?¥Î?ÏßÄ ÎπÑÏú®', 'dw-church'),
                'type' => \Elementor\Controls_Manager::SELECT,
                'default' => '3-2',
                'options' => [
                    '1-1' => __('1:1 (?ïÏÇ¨Í∞ÅÌòï)', 'dw-church'),
                    '4-3' => __('4:3 (?úÏ?)', 'dw-church'),
                    '3-2' => __('3:2 (?¥Îûò??', 'dw-church'),
                    '16-9' => __('16:9 (?Ä?¥Îìú)', 'dw-church'),
                    '21-9' => __('21:9 (?úÎÑ§Îß?', 'dw-church'),
                    'custom' => __('Custom (ÏßÅÏ†ë ?§Ï†ï)', 'dw-church'),
                ],
                'condition' => [
                    'show_thumbnail' => 'yes',
                    'layout' => 'grid',
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'cover',
                'options' => [
                    'cover' => __('Cover (ÍΩ?Ï±ÑÏ?)', 'dw-church'),
                    'contain' => __('Contain (?ÑÏ≤¥ Î≥¥Í∏∞)', 'dw-church'),
                    'fill' => __('Fill (?òÎ¶º)', 'dw-church'),
                    'none' => __('None (?êÎ≥∏)', 'dw-church'),
                    'scale-down' => __('Scale Down (Ï∂ïÏÜå)', 'dw-church'),
                ],
                'selectors' => [
