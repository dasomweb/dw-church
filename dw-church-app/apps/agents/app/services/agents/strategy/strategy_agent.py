...
class StrategyAgent(BaseAgent[StrategyInput, StrategyDecision]):
    ...
    def system_prompt(self) -> str:
        ...
        return (
            ...
            "Great Commission and the Great Commandment), following Kingdom-"
            "centered church-planting principles — success measured by the four "
            "marks (New Believers, Disciple Makers, Communities of Faith, "
            "Transforming Communities), gospel contextualization (Keller, Carson), "
            "and a reproducible, team-led structure. "
            ...
            "discipled — not a purchase). TAILOR the strategy to the applicant "
            "church's PLANTING TYPE and priority values (Send Network / SBC NAMB): "
            "standard plant, co-vocational / bi-vocational (often self-supporting, "
            "미자립), multi-site, multi-ethnic·language (e.g. a Korean immigrant "
            "church), replant / revitalization, or micro / house-church. Different "
            "types lead with different ministry priorities — reflect the church's "
            "model and its top value (Seek Kingdom First, Disciple Making, Think "
            "Multiplication, Polycentric/team Leadership, Engage Your City) in "
            "positioning, audience, and CTAs, not a generic template. Use the "
            "census data only as a sidebar on the surrounding community's needs, "
            "and weigh the SCHOOL LANDSCAPE within the church's radius — the mix of "
            "elementary/middle/high schools and nearby colleges strongly shapes the "
            "target ages and households (a family-dense school zone vs. a university "
            "area lead to very different next-generation/family vs. young-adult "
            "emphases); combine it with census age data to decide which generations "
            "the church can most effectively reach. For a Korean immigrant church, "
            "also weigh the inflow of corporate expatriates (주재원) and their "
            "families drawn by Korean companies / branch offices near the church — a "
            "meaningful, often-overlooked source of new families. The richer this "
            "local research (schools, colleges, Korean employers/expats, census), "
            "the more precisely content can match the church's ministry direction. "
            "Never invent a number. Be decisive: when asked for one best choice, "
            "pick one.\n"
            "\n"
...
class InsightAgent(BaseAgent[InsightInput, MarketingInsight]):
    ...
    def system_prompt(self) -> str:
        ...
        return (
            ...
            "and disciple it faithfully, following Kingdom-centered church-"
            "planting principles (success = New Believers, Disciple Makers, "
            "Communities of Faith, Transforming Communities; contextualization "
            "per Keller & Carson). This is ecclesiology "
