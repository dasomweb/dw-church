    ...
    <div className="min-h-screen bg-white text-[#16181d]" style={{ letterSpacing: '-0.02em' }}>
        ...
        <div className={`${CONTAINER} py-16 sm:py-20`}>
          ...
          <div className="mt-10 grid gap-5 lg:grid-cols-3">
            {[
              ...
              { t: '개척·미자립교회', price: '첫 1년 월 $39 · 초기 구축 $200', d: '개척 이후 이내 또는 자립 이전 교회. 돕는 교회 없이 신청하셔도 같은 조건입니다.' },
      ...
      <section className="border-y border-[#eceae6] bg-[#fbfaf8]">
        <div className={`${CONTAINER} py-14 sm:py-16`}>
          ...
          <p className="mt-4 text-[14.5px] text-[#61697a]">감면 폭과 대상 기준의 세부는 상담에서 확정합니다.</p>
        </div>
      </section>
