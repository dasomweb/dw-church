      ...
      <section className="bg-white">
        <div className={`${CONTAINER} py-16 sm:py-20`}>
          ...
          <div className="mt-10 grid gap-5 lg:grid-cols-3">
            {[
              { t: '돕는 교회', price: '구독료 월 $20 감면', d: '정상 요금 자립교회가 한 교회를 후원하시면 후원하는 동안 감면받으십니다. 한 교회가 자립하면 다음 교회로 이어 계속 함께 세우실 수 있습니다.' },
              { t: '개척·미자립교회', price: '첫 1년 월 $39 · 셋업 $200', d: '자립 이전 교회. 검증된 템플릿으로 빠르게 세워 드리고, 콘텐츠 입력을 함께 돕습니다. 돕는 교회 없이 신청하셔도 같은 조건이며, 1년 후에는 교회 사정에 맞춰 이어서 안내드립니다.' },
