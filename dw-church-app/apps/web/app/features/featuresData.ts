...
export const FEATURE_GROUPS: FeatureGroup[] = [
  {
    ...
    ko: {
      ...
      items: [
        ...
        { name: '사진 앨범', desc: '교회 행사 사진을 갤러리로 모아 보여 줍니다. 카테고리로 나누고, 클릭하면 큰 화면(이미지 확대 보기)으로 확대해 봅니다.' },
  ...
  },
  {
    ...
    ko: {
      ...
      items: [
        ...
        { name: 'SNS 바로가기', desc: '교회 유튜브·인스타그램·카카오 등 채널로 바로 연결되는 버튼을 둡니다.' },
      ],
    },
    en: {
      tab: 'Community',
  ...
  },
  {
    ...
    ko: {
      ...
      items: [
        ...
        { name: '메인 배너 슬라이드', desc: '메인 페이지 상단에 주요 소식을 배너 슬라이드로 강조합니다.' },
        { name: '콘텐츠 내려받기', desc: '등록한 콘텐츠를 내보내 백업할 수 있습니다.' },
