...
const COPY: Record<Lang, Copy> = {
  ko: {
    ...
    hero: {
      ...
      seePlans: '요금제 보기',
      slides: [
        { headline: '섬김에 더\n집중할 수 있도록', subline: '설교와 주보, 행사와 교역자 소개까지\n홈페이지 관리는 저희가 곁에서 돕겠습니다.' },
        { headline: '교회의 걸음을\n온라인에 담습니다', subline: '교회의 모습에 어울리는 디자인으로\n홈페이지를 정성껏 만들어 드립니다.' },
        { headline: '복잡한 일은\n저희에게 맡기셔도 됩니다', subline: '도메인과 모바일 화면, 영상 연동까지 차근차근 준비해\n교회가 사역에 전념하실 수 있도록 돕겠습니다.' },
      ],
    },
