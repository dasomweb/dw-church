...
const COPY: Record<Lang, Copy> = {
  ko: {
    ...
    hero: {
      ...
      seePlans: '요금제 보기',
      slides: [
        { headline: '설교와 주보가 매주 쌓이는 곳', subline: '유튜브 설교를 연동하고 주보 PDF를 올리면, 성도들이 언제 어디서나 다시 봅니다.' },
        { headline: '교회에 필요한 기능이 처음부터', subline: '앨범·행사·교역자·게시판·새가족·목장까지, 교회 운영에 필요한 기능을 한 곳에 담았습니다.' },
        { headline: '전문가가 만드는 교회 홈페이지', subline: '디자인과 셋업은 전문가가 끝내고, 성도는 휴대폰 앱처럼 설치해 사용합니다.' },
      ],
    },
  ...
  en: {
    ...
    hero: {
      ...
      seePlans: 'See Plans',
      slides: [
        { headline: 'Sermons and Bulletins, Added Every Week', subline: 'Link your YouTube sermons and upload bulletin PDFs — your congregation can revisit them anytime, anywhere.' },
        { headline: 'Church Features, Ready From Day One', subline: 'Albums, events, staff, boards, newcomers, small groups — everything your church runs, in one place.' },
        { headline: 'Built by Professionals, Yours to Run', subline: 'We handle the design and setup; your members install it like a mobile app.' },
      ],
    },
