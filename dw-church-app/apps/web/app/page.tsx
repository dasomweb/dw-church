...
const COPY: Record<Lang, Copy> = {
  ko: {
    ...
    hero: {
      ...
      seePlans: '요금제 보기',
      slides: [
        { headline: '교회의 온라인 사역을\n한 곳에서', subline: '설교와 주보, 새가족과 목장까지 —\n교회 운영에 필요한 것을 하나의 솔루션으로.' },
        { headline: '교회를 깊이 이해한\n전문 솔루션', subline: '교회에 꼭 맞는 기능과 디자인을 갖추어\n온라인 사역의 든든한 기틀이 됩니다.' },
        { headline: '기술 전문성은\n솔루션 안에', subline: '어려운 설정과 디자인은 전문적으로 갖춰진 채로,\n교회는 말씀과 소식에 집중합니다.' },
      ],
    },
    ...
    steps: [
      ...
      { step: '02', title: '전문 셋업', desc: '교회에 맞는 디자인이 적용되고, 기존 사이트가 있다면 내용도 그대로 옮겨져 홈페이지가 완성됩니다.' },
    ...
    plans: [
      {
        ...
        features: ['프론트페이지', '담임목사 인사말', '교회 소개', '교역자 소개', '예배 안내', '오시는 길', '교육부 소개', '설교·주보 게시판', '소셜 버튼', '관리자 계정 2개'],
  ...
  en: {
    ...
    hero: {
      ...
      seePlans: 'See Plans',
      slides: [
        { headline: 'Your Church Ministry,\nOnline in One Place', subline: 'Sermons, bulletins, newcomers, small groups —\neverything your church runs online, in one solution.' },
        { headline: 'Built to Understand\nYour Church', subline: 'Church-specific features and design, ready from day one —\nthe backbone of your online ministry.' },
        { headline: 'The Expertise\nIs Built In', subline: 'Setup, design, and security come handled,\nso your church can focus on the Word and its people.' },
      ],
    },
