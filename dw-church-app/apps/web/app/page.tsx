...
const COPY: Record<Lang, Copy> = {
  ko: {
    ...
    hero: {
      ...
      slides: [
        ...
        { headline: '누구나 손쉽게 관리할 수 있습니다', subline: '직관적인 관리자 화면에서 누구나 콘텐츠를 올리고 운영합니다.' },
    ...
    features: [
      ...
      { title: '사진 앨범', desc: '교회의 순간을 아름다운 갤러리로. 이미지 확대 보기 지원.', icon: '📸' },
    ...
    steps: [
      { step: '01', title: '신청 & 플랜 선택', desc: '교회에 맞는 플랜을 정하고 신청서를 작성합니다.' },
      { step: '02', title: '온보딩 (디자인·셋업)', desc: '교회에 맞게 디자인하고 홈페이지 기본 구성을 잡아 드립니다. 기존 사이트가 있으면 내용도 그대로 옮겨 드립니다.' },
    ...
    plansSection: {
      ...
      setupTitle: '온보딩(셋업비)에 포함되는 것',
      setupItems: [
        '교회에 맞는 전문 디자인 제작 및 초기 구성',
        '선택하신 플랜의 페이지·메뉴·기능 설정',
        '기존 웹사이트가 있으면 내용을 그대로 옮겨 구성에 반영',
        '예배 시간·오시는 길·교역자 등 기본 정보 입력',
        '도메인 연결 설정 (보유·구입 도메인 연결 지원)',
        '오픈 전 점검 후 사이트 공개',
      ],
      note: '셋업비는 온보딩 시 한 번만 발생하며, 이후에는 매달(또는 매년) 구독료만 부담합니다.\n더 큰 규모의 교회이신가요? 맞춤 플랜을',
      contact: '문의하세요',
    },
    plans: [
      {
  ...
  en: {
    ...
    steps: [
      ...
      { step: '02', title: 'Onboarding (Design & Setup)', desc: 'We design and set up your site to fit your church; if you have an existing site, we move your content over.' },
    ...
    plansSection: {
      ...
      setupItems: [
        ...
        'Domain connection (bring your own domain)',
