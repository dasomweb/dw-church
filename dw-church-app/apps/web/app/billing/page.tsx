...
const TERMS: { label: string; desc: string }[] = [
  { label: '청구 주기', desc: '선불로 청구됩니다. 연 1회 또는 월 단위 중 교회에 맞춰 상담에서 정합니다.' },
  { label: '신청 자격', desc: '정통 기독교 신앙을 고백하는 교회. 무교단·독립교회도 신청하실 수 있습니다. (약관 §2)' },
              ...
              <div className="rounded-2xl border-2 border-[#1466d6] bg-[#f4f8ff] p-7">
                ...
                <ul className="mt-4 space-y-4">
                  {[
                    ...
                    { t: '저장공간 초과분', v: '넘어설 때만', d: '포함 범위를 넘어서면 초과분에 대해서만 사용료가 발생합니다.' },
                  ].map((row) => (
