  ...
  terms: {
    ...
    ko: {
      ...
      sections: [
        ...
        { h: '2. 자격 요건 및 신앙고백 (Religious Qualification & Discretion)', body: ['본 서비스는 역사적 정통 기독교 신앙("신앙고백")을 고백하고 실천하는 교회를 대상으로 제공됩니다. 특정 신경(信經)의 형식적 가입 여부가 아니라 아래 핵심 교리의 내용에 동의하는지를 기준으로 합니다. 구체적인 교리적 기준은 다음과 같습니다:'], list: FAITH_LIST_KO },
        { h: '', body: [
