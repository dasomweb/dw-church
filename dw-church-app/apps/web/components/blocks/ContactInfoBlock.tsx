          ...
          {settings.phone && (
            <div className="flex items-center gap-4 rounded-2xl border border-black/[0.06] bg-white p-5 shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="min-w-0">
                ...
                <a href={`tel:${settings.phone}`} className="text-base font-semibold text-gray-800 hover:text-[var(--dw-primary)]">{settings.phone}</a>
              </div>
            </div>
          )}
          {settings.email && (
            <div className="flex items-center gap-4 rounded-2xl border border-black/[0.06] bg-white p-5 shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="min-w-0">
                ...
                <a href={`mailto:${settings.email}`} className="text-base font-semibold text-gray-800 hover:text-[var(--dw-primary)] break-all">{settings.email}</a>
              </div>
            </div>
          )}
          {settings.address && (
            <div className="flex items-center gap-4 rounded-2xl border border-black/[0.06] bg-white p-5 shadow-sm hover:shadow-md transition-shadow sm:col-span-2">
              ...
              <div className="min-w-0">
                ...
                <p className="text-base font-semibold text-gray-800">{settings.address}</p>
              </div>
            </div>
          )}
        </div>
