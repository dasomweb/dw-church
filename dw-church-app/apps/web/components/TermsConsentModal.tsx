    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      <div className="flex max-h-[90vh] w-full max-w-2xl flex-col rounded-2xl bg-white shadow-2xl">
        ...
        <div ref={scrollRef} onScroll={onScroll} className="flex-1 overflow-y-auto px-6 py-5 text-sm leading-relaxed text-gray-700">
          ...
          <p className="mb-2">본 서비스는 <strong>역사적 정통 기독교 신앙을 고백하는 교회</strong>를 위한 것입니다. 아래의 핵심 진리를 믿고 고백하는 교회라면 신청하실 수 있습니다. (특정 신경(信經)의 형식적 가입 여부가 아니라, 아래 신앙의 내용에 동의하시는지를 기준으로 합니다.) 구체적으로:</p>
