...
import { InfoBarBlock } from '../list-based/InfoBarBlock';
...
const DATA_BLOCK_LABELS: Record<string, string> = {
  ...
  verse_of_day: '오늘의 말씀 (말씀 관리의 현재 말씀 — 사이트에서 자동 표시, 없으면 숨김)',
  news_announcements: '주보·광고 (주보 모듈 + 교회소식 게시판 — 사이트에서 자동 표시)',
