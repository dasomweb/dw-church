    ...
    return (
      <div className="max-w-4xl mx-auto">
        <div className="mb-8">
          ...
          <h2 className="text-2xl font-bold text-gray-900">{editingItem ? '이벤트 수정' : '이벤트 등록'}</h2>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          <FormSection title="이벤트 정보">
            ...
            <div className="flex items-center justify-between bg-gray-50 rounded-xl px-5 py-4">
              <div>
                <p className="text-sm font-medium text-gray-900">이미지만 사용</p>
                <p className="text-xs text-gray-500 mt-0.5">활성화하면 이미지만 표시됩니다</p>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input type="checkbox" {...register('imageOnly')} className="sr-only peer" />
