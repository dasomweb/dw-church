...
export const BLOCK_DEFS: BlockDef[] = [
  ...
  { type: 'sermon_magazine', label: '설교 매거진', category: '콘텐츠', icon: '📖', nature: 'dynamic', description: '이번 주 설교 — 한줄요약·써머리·질문(관찰·심화·적용)', variants: [{ id: 'default', label: '기본' }], defaultProps: { title: '이번 주 말씀' }, editableFields: [{ key: 'title', label: '상단 라벨', type: 'text' }] },
  { type: 'devotion_reader', label: '말씀 묵상 (QT)', category: '콘텐츠', icon: '📖', nature: 'dynamic', description: '주간 묵상 목록 + 오늘 묵상 (읽기 전용, 관리자 업로드)', variants: [{ id: 'default', label: '기본' }], defaultProps: { title: '말씀 묵상', eyebrow: '이번 주 묵상' }, editableFields: [{ key: 'title', label: '제목', type: 'text' }, { key: 'eyebrow', label: '좌측 라벨', type: 'text' }] },
