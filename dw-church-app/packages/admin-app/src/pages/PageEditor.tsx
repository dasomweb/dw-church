...
export const BLOCK_DEFS: BlockDef[] = [
  ...
  // ─── Content ───────────────────────────────────
  { type: 'recent_sermons', label: '설교', category: '콘텐츠', icon: '🎤', nature: 'dynamic', description: '최근 설교 목록', variants: [{ id: 'grid-4', label: '4열' }, { id: 'grid-3', label: '3열' }, { id: 'grid-2', label: '2열' }, { id: 'list', label: '리스트' }, { id: 'featured', label: '피처드(대표+목록)' }], defaultProps: { limit: 6 }, editableFields: [{ key: 'title', label: '제목', type: 'text' }, { key: 'limit', label: '표시 개수', type: 'number' }] },
  ...
  { type: 'news_announcements', label: '주보·광고', category: '콘텐츠', icon: '🗞️', nature: 'dynamic', description: '주보(주보 모듈) + 광고(교회소식 게시판, 카테고리 배지) 목록 + 기도/심방 버튼', variants: [], defaultProps: { title: '주보 · 광고', bulletinLimit: 3, newsLimit: 4, moreUrl: '/bulletins', button1Label: '기도 요청', button1Url: '/contact', button2Label: '심방 신청', button2Url: '/contact' }, editableFields: [{ key: 'title', label: '제목', type: 'text' }, { key: 'boardSlug', label: '교회소식 게시판 슬러그', type: 'text' }, { key: 'bulletinLimit', label: '주보 개수', type: 'number' }, { key: 'newsLimit', label: '광고 개수', type: 'number' }] },
