...
export const BLOCK_DEFS: BlockDef[] = [
  ...
  { type: 'news_announcements', label: '주보·광고', category: '콘텐츠', icon: '🗞️', nature: 'dynamic', description: '주보(주보 모듈) + 광고(교회소식 게시판, 카테고리 배지) 목록 + 원하는 만큼 추가하는 버튼', variants: [], defaultProps: { title: '주보 · 광고', bulletinLimit: 3, newsLimit: 4, moreUrl: '/bulletins', buttons: [{ text: '기도 요청', url: '/contact' }, { text: '심방 신청', url: '/contact' }] }, editableFields: [{ key: 'title', label: '제목', type: 'text' }, { key: 'boardSlug', label: '교회소식 게시판', type: 'board-select' }, { key: 'bulletinLimit', label: '주보 개수', type: 'number' }, { key: 'newsLimit', label: '광고 개수', type: 'number' }, { key: 'buttons', label: '버튼', type: 'buttons' }] },
