...
const BLOCK_REGISTRY: BlockMeta[] = [
  ...
  { type: 'staff_grid', label: '교역자 그리드', category: '콘텐츠', icon: 'SG', description: '교역자 카드', defaultProps: { limit: 8, layout: 'featured', photoStyle: 'rect', columns: 3, showItems: 'name,role,department,bio' }, propsSchema: [{ key: 'title', type: 'string', label: '제목' }, { key: 'limit', type: 'number', label: '표시 개수', defaultValue: 8, min: 1, max: 50 }, { key: 'layout', type: 'select', label: '레이아웃', options: [{ label: '담임목사 강조 + 그리드', value: 'featured' }, { label: '전체 그리드', value: 'grid' }, { label: '전체 리스트', value: 'list' }] }, { key: 'photoStyle', type: 'select', label: '사진 스타일', options: [{ label: '사각형', value: 'rect' }, { label: '원형', value: 'circle' }] }, { key: 'columns', type: 'select', label: '열 수', options: [{ label: '2열', value: '2' }, { label: '3열', value: '3' }, { label: '4열', value: '4' }] }, { key: 'showItems', type: 'string', label: '표시항목 (콤마구분)', defaultValue: 'name,role,department,bio' }] },
