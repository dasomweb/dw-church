...
export const BLOCK_DEFS: BlockDef[] = [
  ...
  { type: 'cardnews', label: '카드뉴스', category: '콘텐츠', icon: '🗞️', nature: 'static', description: '정사각 이미지 카드로 보내는 소식(운영자 업로드) — 시안 15a', variants: [], defaultProps: { variant: 'cardnews', eyebrow: '카드뉴스', title: '한 장으로 보내는 소식', items: [{ title: '말씀 카드', description: '이번 주 말씀을 한 장으로', imageUrl: '' }, { title: '모임 안내', description: '이번 주 모임 소식', imageUrl: '' }] }, editableFields: [{ key: 'eyebrow', label: '라벨(윗글)', type: 'text' }, { key: 'title', label: '제목', type: 'text' }, { key: 'items', label: '카드 항목(제목·설명·이미지)', type: 'cardItems', withImage: true }] },
