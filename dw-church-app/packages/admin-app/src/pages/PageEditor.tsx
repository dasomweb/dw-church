...
const BLOCK_DEFS: BlockDef[] = [
  ...
  { type: 'quick_links', label: '바로가기', category: '소개', icon: '🔗', nature: 'static', description: '제목 + 화살표 링크 목록 (기도 요청 →, 소그룹 신청 → 등)', variants: [], defaultProps: { title: '바로가기', items: [] }, editableFields: [{ key: 'title', label: '제목', type: 'text' }, { key: 'items', label: '링크 (제목=라벨, 내용=URL)', type: 'cardItems', withImage: false }] },
];
