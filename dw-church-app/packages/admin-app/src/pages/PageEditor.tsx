...
const BLOCK_DEFS: BlockDef[] = [
  ...
  { type: 'logo_title', label: '로고+타이틀', category: '텍스트', icon: '🏷️', nature: 'static', description: '로고 이미지 + 제목 + 부제 (중앙)', variants: [{ id: 'center', label: '중앙 정렬' }], defaultProps: { title: '', subtitle: '', logoUrl: '', logoWidth: 96 }, editableFields: [{ key: 'logoUrl', label: '로고', type: 'image' }, { key: 'title', label: '제목', type: 'text' }, { key: 'subtitle', label: '부제', type: 'text' }, { key: 'logoWidth', label: '로고 크기(px)', type: 'number' }] },
