...
// ─── 배너 이미지 생성 가이드 ──────────────────────────────────
// Reuses the shared <ImagePromptGuide>; only the sizes + intro differ.
const BANNER_GUIDE_SIZES: PromptSize[] = [
...
function BannerImageGuide() {
  return <ImagePromptGuide sizes={BANNER_GUIDE_SIZES} title="배너 이미지 만들기 가이드 (AI 이미지 생성)" intro={BANNER_INTRO} />;
}
