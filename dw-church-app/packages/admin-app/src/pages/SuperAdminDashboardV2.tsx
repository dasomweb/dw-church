...
import { TabIcon, StatusBadge, VerifyBadge, Spinner, EmptyState } from '../super-admin/shared/admin-ui';
import { formatDate, formatBytes } from '../super-admin/shared/format';
import type { Tenant, GlobalStats, TenantsResponse, TenantDetail } from '../super-admin/shared/types';
import { PLAN_COLORS } from '../super-admin/shared/constants';
