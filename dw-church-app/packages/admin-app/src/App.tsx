...
const ScheduleManagement = lazyWithReload(() => import('./pages/ScheduleManagement'));
...
const CardnewsManagement = lazyWithReload(() => import('./pages/CardnewsManagement'));
...
const tenantChildRoutes = (
  <>
    ...
    <Route path="cardnews" element={<CardnewsManagement />} />
    ...
    <Route path="newcomers-register" element={<NewcomerRegister />} />
