...
const navGroups: (NavItem | NavGroup)[] = [
  ...
  { label: '콘텐츠', items: [
    // 초기 셋업은 교회(테넌트)가 가입 후 콘텐츠를 올리는 단계 — 저장(draft)해두고
    // 다시 로그인해 이어서 추가할 수 있다(IntakeWizard).
    { to: 'onboarding', label: '초기 셋업', icon: I('M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z') },
