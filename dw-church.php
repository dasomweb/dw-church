 ...
 */
// Get version from plugin header to ensure consistency
if (!function_exists('get_plugin_data')) {
    require_once(ABSPATH . 'wp-admin/includes/plugin.php');
}
$plugin_data = get_plugin_data(__FILE__, false, false);
$plugin_version = isset($plugin_data['Version']) ? $plugin_data['Version'] : '2.70.0';
define('DASOM_CHURCH_VERSION', $plugin_version);
